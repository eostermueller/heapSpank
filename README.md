...
```java -jar target/heapSpank-0.6.jar 81731
...
1. Unzip [heapSpank zip file](https://github.com/eostermueller/heapSpank/releases/download/v0.6/heapSpank-0.6.jar) to a new folder on your hard disk.
